import Bg from "@/assets/images/onbbg03.jpg"
    ...
    <SafeAreaView>
      <ImageBackground
        ...
        <View style={{marginHorizontal:10}}>
          <TouchableOpacity onPress={() => {router.push('/home-scroll')}}>
          ...
          <View style={{flexDirection:"row", marginTop:90, marginBottom:50, gap:5, marginHorizontal:60, alignItems:"center", justifyContent:"center"}}>
            <Image source={RecL} style={{width:25, height:10, tintColor:"#455AF7"}} resizeMode="cover"/>
            <Image source={RecC} style={{width:35, height:10, tintColor:"#455AF7"}} resizeMode="cover"/>
